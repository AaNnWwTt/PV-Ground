...
class Joint3DDataset(Dataset):
    ...
    def __init__(self, dataset_dict={'sr3d': 1, 'scannet': 10},
        ...
        for scan in self.scans:
            superpoint = torch.load(os.path.join(f'{self.data_path}/superpoints', self.split, scan + "_superpoint.pth"), weights_only=False)
    ...
    def __getitem__(self, index):
        ...
        ret_dict.update({
            ...
            "all_bbox_label_mask": all_bbox_label_mask.astype(np.bool),
            ...
            "all_detected_bbox_label_mask": all_detected_bbox_label_mask.astype(np.bool),
